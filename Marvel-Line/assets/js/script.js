...
const backgroundMusic = new Audio('./assets/sounds/avengers_bg.mp3');
const resultMusic = new Audio('./assets/sounds/avengers_play.mp3');
...
const RunAnimation = (Top,Line) => {
    ...
    (Top == 'left' && Line == 3) && avengersAni_01().then(() => setTimeout(() => {ResetAnimation()},2000));
    (Top == 'left' && Line == 4) && avengersAni_02().then(() => setTimeout(() => {ResetAnimation()},2000));
    (Top == 'right' && Line == 3) && avengersAni_03().then(() => setTimeout(() => {ResetAnimation()},2000));
    (Top == 'right' && Line == 4) && avengersAni_04().then(() => setTimeout(() => {ResetAnimation()},2000));
...
const RefreshHistory = () => {
    $.ajax(URL + '/marvel-line/history').then((res) => {
        res.map((item,index) => {
